...
//enviar hasta 6 imagenes

 // Método para subir hasta 6 imágenes
...
//     formData.append(`foto${i + 1}`, imagenes[i]);
//   }

//   return this.http.post(`${url_usuarioRegistro}/Imagenes`, formData);
// }
...
//   // Asegúrate de que el encabezado Content-Type sea multipart/form-data
//   headers.append('Content-Type', 'multipart/form-data');

//   return this.http.post(`${url_usuarioRegistro}/Imagenes`, formData, { headers });
// }
...
// debugger
// for (let i = 0; i < Math.min(imagenes.length, 6); i++) {
//   formData.append(`imagen${i + 1}`, imagenes[i], imagenes[i].name);
//   debugger
//   }
// debugger
...
//     // Combinar observables para esperar que todas las imágenes se completen
//     forkJoin(observables).subscribe((compressedImages: File[]) => {
//       for (let i = 0; i < compressedImages.length; i++) {
//         formData.append(`imagen${i + 1}`, compressedImages[i], compressedImages[i].name);
//       }

//       // Enviar la solicitud HTTP con las imágenes comprimidas
//       this.http.post(`${url_usuarioRegistro}/Imagenes/Subir`, formData)
//         .subscribe(response => {
//           // Manejar la respuesta, si es necesario
//           // console.log(response);
//           Swal.fire('Operación Exitosa', 'Apartamento y otros campos creadoss', 'success');
//         });
//     });

//   // Devolver un observable para que el componente que llama pueda suscribirse
//   return EMPTY; // Puedes devolver un observable vacío o ajustarlo según tus necesidades
// }
